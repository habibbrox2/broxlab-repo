...
@section('title', 'Category Details — '.($appSettings['site_name'] ?? 'BroxLab'))
            ...
            <dl class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div class="space-y-1">
                    ...
                    <dd class="text-sm font-medium text-slate-900 dark:text-white">
                        <code class="rounded-md bg-slate-100 dark:bg-slate-800 px-2 py-0.5 text-xs text-slate-600 dark:text-slate-400">{{ $category->slug ?? 'N/A' }}</code>
                    </dd>
                </div>
            </dl>
        </div>

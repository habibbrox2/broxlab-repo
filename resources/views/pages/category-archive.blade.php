...
<section class="relative overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 py-14 text-white md:py-18">
    <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav class="mb-4 flex items-center gap-1.5 text-xs text-white/60" aria-label="Breadcrumb">
            <a href="/categories" class="inline-flex items-center gap-1 hover:text-white"><i class="lucide lucide-folder-open h-3.5 w-3.5"></i> Categories</a>
...
<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    @if (!empty($contents))
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3" role="feed" aria-label="Category content feed">

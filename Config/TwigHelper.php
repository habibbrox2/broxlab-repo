...
if (!function_exists("registerTwigHelpers")) {
    function registerTwigHelpers(\Twig\Environment $twig, mysqli $mysqli, array &$session, array $appSettings, string $configUrl): void
    {
        ...
        $publicNavItems = [
            ['label' => 'Home', 'url' => '/', 'icon' => 'lucide-house', 'match' => '/', 'enabled' => true, 'order' => 10],
            ['label' => 'Mobiles', 'url' => '/mobiles', 'icon' => 'lucide-smartphone', 'match' => '/mobiles', 'enabled' => true, 'order' => 20],
            ['label' => 'Articles', 'url' => '/posts', 'icon' => 'lucide-newspaper', 'match' => '/posts', 'enabled' => true, 'order' => 30],
            ['label' => 'Services', 'url' => '/services', 'icon' => 'lucide-award', 'match' => '/services', 'enabled' => true, 'order' => 40],
        ];

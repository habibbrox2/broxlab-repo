...
if (!function_exists("registerTwigHelpers")) {
    function registerTwigHelpers(\Twig\Environment $twig, mysqli $mysqli, array &$session, array $appSettings, string $configUrl): void
    {
                ...
                $twig->addFilter(new \Twig\TwigFilter('role_badge', function ($roleName) {
                    $badges = [
                        'super_admin' => '<span class="badge bg-danger"><i class="bi bi-shield-lock mr-1"></i>Super Admin</span>',
                        'admin' => '<span class="badge bg-warning"><i class="bi bi-shield-check mr-1"></i>Admin</span>',
                        'moderator' => '<span class="badge bg-info"><i class="bi bi-shield mr-1"></i>Moderator</span>',
                        'user' => '<span class="badge bg-secondary"><i class="bi bi-person mr-1"></i>User</span>',
                    ];

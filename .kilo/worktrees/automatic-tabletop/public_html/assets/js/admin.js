  ...
  function initActivityLog() {
    ...
    function renderLog(log) {
      ...
      row.innerHTML = `
                ...
                <td class="log-user"><i class="bi bi-person-circle mr-2"></i>${username}</td>
                                ...
                                <div class="admin-panel-card border shadow-sm h-100">
                                    ...
                                    <div class="card-body p-3">
                                        <h6 class="card-title text-truncate mb-2" title="${file.name}">
                                            <i class="bi bi-image text-primary mr-1"></i>${file.name}
                                        </h6>
          ...
          if (data.success) {
            ...
            detailContent.innerHTML = `
                            ...
                            <div class="mb-3">
                                ...
                                <p>
                                    ${notif.channels.includes('push') ? '<span class="badge bg-primary mr-2"><i class="bi bi-phone"></i> Push</span>' : ''}
                                    ${notif.channels.includes('email') ? '<span class="badge bg-success mr-2"><i class="bi bi-envelope"></i> Email</span>' : ''}

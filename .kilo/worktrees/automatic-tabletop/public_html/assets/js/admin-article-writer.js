...
(function () {
  ...
  function setGenerating(state) {
    ...
    generateBtn.innerHTML = state
      ...
      : '<i class="bi bi-magic mr-1"></i> <span id="generateBtnText">Generate Article</span>';
  }
  ...
  function setPublishing(state) {
    ...
    publishBtn.innerHTML = state
      ...
      : '<i class="bi bi-globe mr-1"></i> Publish Now';
  ...
  function renderArticle(article) {
    ...
    if (kp.length) {
      ...
      articleKeyPoints.innerHTML = '<h6 class="fw-semibold mb-2"><i class="bi bi-list-check mr-1"></i>Key Points</h6>' +
    ...
    publishBtn.innerHTML = '<i class="bi bi-globe mr-1"></i> Publish Now';
    publishBtn.disabled = false;
    publishBtn.className = 'btn btn-success';
    saveDraftBtn.innerHTML = '<i class="bi bi-save mr-1"></i> Save as Draft';
  ...
  function saveArticle(publish) {
    ...
    .then(function (d) {
      ...
      if (publish) { publishBtn.innerHTML = '<i class="bi bi-check-circle mr-1"></i> Published'; publishBtn.disabled = true; }
      else { saveDraftBtn.innerHTML = '<i class="bi bi-check-circle mr-1"></i> Draft Saved'; saveDraftBtn.disabled = true; }
    })
    .catch(function (err) {
      setPublishing(false);

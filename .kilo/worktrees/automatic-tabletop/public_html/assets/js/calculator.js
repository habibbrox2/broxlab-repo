...
(function () {
    ...
    function renderFinancial(type, r) {
        ...
        return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi bi-check-circle-fill mr-2"></i><span class="fw-bold">Result</span></div>' +
    ...
    function renderPercentage(r) {
        return '<p class="fs-3 fw-bold text-center text-primary"><i class="bi bi-percent mr-2"></i>' +
    ...
    function renderBMI(r) {
        return '<div class="result-highlight" style="background:linear-gradient(135deg,#11998e,#38ef7d)">' +
            ...
            '<p class="text-muted mt-2 mb-0"><i class="bi bi-info-circle mr-1"></i>' + r.description + '</p>';
    }
    ...
    function renderGraphing(r) {
        ...
        return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi bi-sliders mr-2"></i><span class="fw-bold">Graphing Sample Values</span></div>' +
    ...
    function renderStandardScientific(r) {
        return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi bi-calculator mr-2"></i><span class="fw-bold">Result</span></div>' +
    ...
    function renderProgrammer(r) {
        return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi bi-code-slash mr-2"></i><span class="fw-bold">Programmer Conversion</span></div>' +
    ...
    function renderDateCalculation(r) {
        ...
        return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi bi-calendar-event mr-2"></i><span class="fw-bold">Date Calculation</span></div>' +
            '<div class="result-body p-3">' +
    ...
    function renderConverter(r) {
        return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi bi-arrow-left-right mr-2"></i><span class="fw-bold">Converted Value</span></div>' +
            '<div class="result-body p-3">' +
        ...
        fetch(endpoint, {
            ...
            .then(async function (resp) {
                ...
                if (resp.redirected || (resp.status >= 300 && resp.status < 400)) {
                    ...
                    resultsPanel.innerHTML = '<div class="alert alert-danger"><i class="bi bi-exclamation-triangle mr-2"></i>' +
            ...
            .catch(function (err) {
                ...
                resultsPanel.innerHTML = '<div class="alert alert-danger"><i class="bi bi-wifi-off mr-2"></i>' +

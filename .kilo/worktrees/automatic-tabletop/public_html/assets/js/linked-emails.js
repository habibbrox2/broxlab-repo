                    ...
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                ${isPrimary ? '<span class="badge bg-success"><i class="bi bi-star-fill mr-1"></i>Primary</span>' : ''}
                                ${!isVerified ? '<span class="badge bg-warning"><i class="bi bi-clock mr-1"></i>Pending</span>' : ''}
                            </div>
                        ...
                        <div class="btn-group btn-group-sm gap-2" role="group">
                            ${!isPrimary && isVerified ? `
                                <button type="button" class="btn btn-outline-primary js-set-primary" data-email="${escapeHtml(email)}">
                                    <i class="bi bi-star mr-1"></i> Set Primary
                                </button>
                            ` : ''}

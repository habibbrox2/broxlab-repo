(function () {
  ...
  const wireBulkExport = function () {
    ...
    button.addEventListener('click', () => {
      ...
      button.innerHTML = '<i class="bi bi-hourglass-split mr-1"></i> Preparing ZIP...';
  ...
  const wireToggleButtons = function () {
    ...
    forms.forEach((form) => {
      form.addEventListener('submit', (event) => {
        ...
        const originalLabel = button.innerHTML;
        button.disabled = true;
        button.innerHTML = '<i class="bi bi-hourglass-split mr-1"></i> Processing...';
        ...
        fetch(form.action, {
          ...
          .then((data) => {
            if (data.success) {
              ...
              button.innerHTML = `<i class="bi ${ isActive ? 'bi-pause-fill' : 'bi-play-fill' } mr-1"></i> ${
              ...
              if (badge) {
                badge.className = `badge ml-2 ${ isActive ? 'bg-success' : 'bg-danger'}`;

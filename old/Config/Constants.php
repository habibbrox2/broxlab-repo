...
// Debug mode: explicitly enabled via APP_DEBUG env var, NOT inferred from maintenance mode
// This prevents verbose debug logging (route matches, Twig init, etc.) from flooding logs
define('DEBUG_MODE', ($_ENV['APP_DEBUG'] ?? getenv('APP_DEBUG') ?? '0') === '1');

    ...
    .map((brand) => {
      ...
      return `
          <tr class="medex-hover-lift">
            <td>
              <a href="${PAGE_PREFIX}/brand/${encodeURIComponent(brand._id)}" class="no-underline font-semibold medex-brand-name">
            ...
            <td class="text-center">
              <a href="${PAGE_PREFIX}/brand/${encodeURIComponent(brand._id)}" class="medex-btn medex-btn--details">
...
function renderCompanyTableRows(companies, baseIndex) {
  return companies
    .map((company, idx) => {
      ...
      const companyUrl = `${PAGE_PREFIX}/company/${encodeURIComponent(company._id)}`;
      return `
            <tr class="medex-hover-lift">
...
function initCompanyPage() {
  ...
  fetchJson(`${API_PREFIX}/company/${companyId}`)
    .then((data) => {
...
function initCompaniesPage() {
  ...
  fetchJson(`${API_PREFIX}/companies`)
    .then((data) => {
...
function initBrandPage() {
  ...
  initBrandLangToggle();
  fetchJson(`${API_PREFIX}/brand/${brandId}`)
    .then((data) => {

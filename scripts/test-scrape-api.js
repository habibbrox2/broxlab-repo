...
const directBase = String(process.env.SCRAPER_DIRECT_API_URL || 'http://127.0.0.1:7020').replace(/\/+$/, '');
const queueBase = String(process.env.SCRAPER_API_URL || 'http://127.0.0.1:7010').replace(/\/+$/, '');

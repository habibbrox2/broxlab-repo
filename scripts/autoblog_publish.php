<?php
// AutoBlog Publish Script - Run via cron to auto-publish processed articles
// Cron: */5 * * * * php /path/to/scripts/autoblog_publish.php
...
use App\Modules\AutoBlog\AutoPublisher;

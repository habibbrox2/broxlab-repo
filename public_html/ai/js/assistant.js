        ...
        bindEvents() {
            ...
            if (this.nodes.input) {
                ...
                this.nodes.input.addEventListener('keydown', (e) => {
                    ...
                    // Escape to close suggestions or model bar
                    if (e.key === 'Escape') {
                        if (this.nodes.suggestions && !this.nodes.suggestions.classList.contains('brox-ai-hidden')) {
                            this.nodes.suggestions.classList.add('brox-ai-hidden');
                            e.preventDefault();
                            return;
                        }
                        if (this.modelBarOpen) {
                            this.closeModelBar();
                            e.preventDefault();
                            return;
                        }
        ...
        async getAIResponse() {
            ...
            try {
                ...
                const fetchChat = async () => {
                    ...
                    if (!response.ok && CONFIG.proxyUrl === '/ai/chat') {

...
const REGISTRY = {
  ...
  'window.filterNotifications': { source: 'modules/notifications-workflows.js', purpose: 'Filter notifications', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.loadNotificationDetail': { source: 'modules/notifications-workflows.js', purpose: 'Load notification detail', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.deleteNotification': { source: 'modules/notifications-workflows.js', purpose: 'Delete notification', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.refreshDeviceList': { source: 'modules/notifications-workflows.js', purpose: 'Refresh device list', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.manualSync': { source: 'modules/notifications-workflows.js', purpose: 'Manual sync', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.syncDevice': { source: 'modules/notifications-workflows.js', purpose: 'Sync device', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.removeDevice': { source: 'modules/notifications-workflows.js', purpose: 'Remove device', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.clearSyncLog': { source: 'modules/notifications-workflows.js', purpose: 'Clear sync log', category: 'NECESSARY', usedBy: 'data-action in admin', },
  'window.filterSyncLog': { source: 'modules/notifications-workflows.js', purpose: 'Filter sync log', category: 'NECESSARY', usedBy: 'data-action in admin', },

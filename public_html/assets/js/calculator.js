...
if (form) {
  ...
  function renderFinancial(type, r) {
    ...
    return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi icon-check-circle mr-2"></i><span class="fw-bold">Result</span></div>' +
  ...
  function renderPercentage(r) {
    return `<p class="fs-3 fw-bold text-center text-primary"><i class="bi icon-percent mr-2"></i>${
  ...
  function renderBMI(r) {
    return '<div class="result-highlight" style="background:linear-gradient(135deg,#11998e,#38ef7d)">' +
            ...
            `<p class="text-muted mt-2 mb-0"><i class="bi icon-info mr-1"></i>${ r.description }</p>`;
  }
  ...
  function renderGraphing(r) {
    ...
    return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi icon-sliders-horizontal mr-2"></i><span class="fw-bold">Graphing Sample Values</span></div>' +
  ...
  function renderStandardScientific(r) {
    return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi icon-calculator mr-2"></i><span class="fw-bold">Result</span></div>' +
  ...
  function renderProgrammer(r) {
    return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi icon-code mr-2"></i><span class="fw-bold">Programmer Conversion</span></div>' +
  ...
  function renderDateCalculation(r) {
    ...
    return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi icon-calendar-clock mr-2"></i><span class="fw-bold">Date Calculation</span></div>' +
            '<div class="result-body p-3">' +
  ...
  function renderConverter(r) {
    return '<div class="result-card border-primary">' +
            '<div class="result-header bg-primary text-white"><i class="bi icon-arrow-left-right mr-2"></i><span class="fw-bold">Converted Value</span></div>' +
            '<div class="result-body p-3">' +
    ...
    resultsPanel.querySelectorAll('.result-highlight, .result-value').forEach((el) => {
      ...
      btn.addEventListener('click', () => {
        ...
        navigator.clipboard.writeText(text).then(() => {
          ...
          setTimeout(() => { btn.innerHTML = '<i class="bi icon-clipboard"></i> Copy'; }, 2000);
        });
      });
      el.appendChild(btn);
    });
    ...
    fetch(endpoint, {
      ...
      .then(async (resp) => {
        ...
        if (resp.redirected || (resp.status >= 300 && resp.status < 400)) {
          ...
          resultsPanel.innerHTML = '<div class="p-4 rounded-lg bg-danger-light text-danger-dark border border-danger"><i class="bi icon-alert-triangle mr-2"></i>' +
      ...
      .catch((err) => {
        ...
        resultsPanel.innerHTML = '<div class="p-4 rounded-lg bg-danger-light text-danger-dark border border-danger"><i class="bi icon-wifi-off mr-2"></i>' +

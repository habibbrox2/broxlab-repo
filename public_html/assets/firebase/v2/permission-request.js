      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header border-0 pb-0">
            ...
            <button type="button" class="btn-close" data-brox-dismiss="modal" id="dismissModalBtn" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <p class="lead">আমাদের সর্বশেষ আপডেট এবং গুরুত্বপূর্ণ বিজ্ঞপ্তি সরাসরি পান।</p>
            
            <div class="p-4 rounded-lg bg-info-light text-info-dark border border-info d-flex gap-3 mb-3">
          ...
          <div class="modal-footer border-0 pt-0">
            <button type="button" class="btn btn-light" id="laterBtn" data-brox-dismiss="modal">পরে জিজ্ঞাসা করবেন</button>
...
export function updatePermissionStatus() {
  ...
  case 'granted':
    html = `
        <div class="p-4 rounded-lg bg-success-light text-success-dark border border-success d-flex align-items-center mb-0">
          <i class="bi icon-check-circle mr-2"></i>
  ...
  case 'denied':
    html = `
        <div class="p-4 rounded-lg bg-warning-light text-warning-dark border border-warning d-flex align-items-center mb-0">
  ...
  default:
    html = `
        <div class="p-4 rounded-lg bg-neutral-100 text-neutral-700 border border-neutral-200 d-flex align-items-center mb-0">

// public_html/assets/firebase/v2/firebase-config.js
(function initFirebaseRuntimeConfig(global) {
  ...
  const modernOverrides = isPlainObject(global.__APP_FIREBASE_CONFIG_OVERRIDES) ? global.__APP_FIREBASE_CONFIG_OVERRIDES : {};
  ...
  if (global.__FC_DEBUG === void 0) {
    global.__FC_DEBUG = mergedFirebaseConfig.logging.consoleEnabled === true;
  }
  if (global.__FC_DEBUG_LEVEL === void 0) {
    global.__FC_DEBUG_LEVEL = String(mergedFirebaseConfig.logging.level || "warn");
  }
  if (global.__FC_DEBUG_MODULES === void 0 && isPlainObject(mergedFirebaseConfig.logging.firebaseModules)) {

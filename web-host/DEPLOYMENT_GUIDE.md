...
| Item | Detail |
|------|--------|
| Hosting Package | default_tdhuedhn |
| Server Name | server |
| cPanel Version | 130.0 (build 15) |
| Apache Version | 2.4.66 |
| Database Version | 10.11.14-MariaDB |
| Architecture | x86_64 |
| Operating System | linux |
| Shared IP Address | 65.21.174.100 |
| Path to Sendmail | /usr/sbin/sendmail |
| Path to Perl | /usr/bin/perl |
| Perl Version | 5.32.1 |
| Kernel Version | 4.18.0-553.72.1.el8_10.x86_64 |

### Service Information

| Service | Status | Details |
|---------|--------|---------|
| apache_php_fpm | up | "apache_php_fpm" is ok. |
| cpanel_php_fpm | up | "cpanel_php_fpm" is ok. |
| cpanellogd | up | "cpanellogd" is ok. |
| cpdavd | up | "cpdavd" is ok. |
| cphulkd | up | "cphulkd" is ok. |
| cpsrvd | up | "cpsrvd" is ok. |
| crond | up | "crond" is ok. |
| dnsadmin | up | "dnsadmin" is ok. |
| exim (4.98.2-1.cp118~el9) | up | "exim" is ok. |
| ftpd | up | "ftpd" is ok. |
| httpd (2.4.66) | up | "httpd" is ok. |
| imap | up | "imap" is ok. |
| ipaliases | up | "ipaliases" is ok. |
| letsencrypt-cpanel | up | "letsencrypt-cpanel" is ok. |
| lmtp | up | "lmtp" is ok. |
| mailman | up | "mailman" is ok. |
| mysql (10.11.14-MariaDB) | up | "mysql" is ok. |
| named | up | "named" is ok. |
| nscd | up | "nscd" is ok. |
| p0f | up | "p0f" is ok. |
| pop | up | "pop" is ok. |
| queueprocd | up | "queueprocd" is ok. |
| rsyslogd | up | "rsyslogd" is ok. |
| spamd | up | "spamd" is ok. |
| sshd | up | "sshd" is ok. |
| Server Load | ok | 0.25 |
| CPU Count | ok | 14 |
| Memory Used | ok | 53.44% |
| Swap | ok | 0.00% |
| Disk / (/) | ok | 63% |
| Disk /tmp (/tmp) | ok | 0% |
| Disk /boot (/boot) | ok | 25% |
| Disk /home (/home) | ok | 58% |
| Disk /var/tmp (/var/tmp) | ok | 0% |
